...
* **Die Bemerkung** beginnt bei belegtem TOP mit dem Topic-Namen, bei ganzen
  Bytes gefolgt von Einheit und Kodierung. Weitere Kennzeichen:
...
| SET | Kommando | Byte | Bits | TOP | Bemerkung |
| :--- | :--- | ---: | :--- | :--- | :--- |
...
| SET5 | `Z1HeatRequestTemperature` | 38 | ganz | TOP27 | `Z1_Heat_Request_Temp` (°C, Rohwert − 128) — Heiz-Sollwert Zone 1: Direktvorgabe, im Kurvenbetrieb Parallelverschiebung −5…+5 ² ⁶ |
| SET6 | `Z1CoolRequestTemperature` | 39 | ganz | TOP28 | `Z1_Cool_Request_Temp` (°C, Rohwert − 128) — Kühl-Sollwert Zone 1, sonst wie Byte 38 ² ⁶ |
...
| SET11 | `DHWTemp` | 42 | ganz | TOP9 | `DHW_Target_Temp` (°C, Rohwert − 128) — Warmwasser-Solltemperatur |
|  |  | 43 | ganz | TOP45 | `Room_Holiday_Shift_Temp` (K, Rohwert − 128) — Absenkung Raumheizung im Urlaubsbetrieb; ob beschreibbar, ist nicht geprüft (3a) |
|  |  | 44 | ganz | TOP25 | `DHW_Holiday_Shift_Temp` (K, Rohwert − 128) — Absenkung Warmwasser im Urlaubsbetrieb; ob beschreibbar, ist nicht geprüft (3a) |
| SET15 | `WaterPumpSpeed` | 45 | ganz | TOP103 | `Pump_Duty_Max` (Duty, Rohwert − 1) — Obergrenze der Pumpenmodulation, keine Drehzahl; die Ist-Werte sind TOP65 und TOP92. Gemessen 2026-08-19 ⁵ |
...
| SET23 | `SGReadyCapacity1DHW` | 71 | ganz | TOP94 | `SGReady_Capacity1_DHW` (%, Rohwert − 1) — SG Ready Stufe 1, Leistung Warmwasser. Die Referenz beschriftet Byte 71 als Heizen; maßgeblich ist die Firmware, an dieser Anlage ausgetestet |
| SET22 | `SGReadyCapacity1Heat` | 72 | ganz | TOP93 | `SGReady_Capacity1_Heat` (%, Rohwert − 1) — SG Ready Stufe 1, Leistung Heizen; Referenz umgekehrt, siehe Byte 71 |
| SET25 | `SGReadyCapacity2DHW` | 73 | ganz | TOP96 | `SGReady_Capacity2_DHW` (%, Rohwert − 1) — SG Ready Stufe 2, Leistung Warmwasser; Referenz umgekehrt, siehe Byte 71 |
| SET24 | `SGReadyCapacity2Heat` | 74 | ganz | TOP95 | `SGReady_Capacity2_Heat` (%, Rohwert − 1) — SG Ready Stufe 2, Leistung Heizen; Referenz umgekehrt, siehe Byte 71 |
| SET27 | `Z1HeatCurveTargetHighTemp` | 75 | ganz | TOP29 | `Z1_Heat_Curve_Target_High_Temp` (°C, Rohwert − 128) — Heizkurve: Vorlauf bei kaltem Wetter („VL kalt“), gehört zu Byte 77. Im Direktbetrieb dieselbe Speicherstelle wie Byte 38 ² |
| SET28 | `Z1HeatCurveTargetLowTemp` | 76 | ganz | TOP30 | `Z1_Heat_Curve_Target_Low_Temp` (°C, Rohwert − 128) — Heizkurve: Vorlauf bei warmem Wetter („VL warm“), gehört zu Byte 78 |
| SET29 | `Z1HeatCurveOutsideLowTemp` | 77 | ganz | TOP32 | `Z1_Heat_Curve_Outside_Low_Temp` (°C, Rohwert − 128) — Heizkurve: kalter Außentemperaturpunkt („AT kalt“), −15…15 |
| SET30 | `Z1HeatCurveOutsideHighTemp` | 78 | ganz | TOP31 | `Z1_Heat_Curve_Outside_High_Temp` (°C, Rohwert − 128) — Heizkurve: warmer Außentemperaturpunkt („AT warm“), −15…15; ausgemessen, der früher angenommene Bereich 15…35 lag daneben |
...
| SET21 | `HeatingOffOutdoorTemp` | 83 | ganz | TOP77 | `Heating_Off_Outdoor_Temp` (°C, Rohwert − 128) — Heizgrenze: oberhalb dieser Außentemperatur wird nicht geheizt |
| SET16 | `HeatDelta` | 84 | ganz | TOP23 | `Heat_Delta` (K, Rohwert − 128) — Spreizung Heizen |
| SET20 | `HeaterOnOutdoorTemp` | 85 | ganz | TOP78 | `Heater_On_Outdoor_Temp` (°C, Rohwert − 128) — Heizstab erst unterhalb dieser Außentemperatur zugelassen |
| SET31 | `Z1CoolCurveTargetHighTemp` | 86 | ganz | TOP72 | `Z1_Cool_Curve_Target_High_Temp` (°C, Rohwert − 128) — Kühlkurve: Vorlauf bei kühlem Wetter, gehört zu Byte 88. Im Direktbetrieb dieselbe Speicherstelle wie Byte 39 ² |
| SET32 | `Z1CoolCurveTargetLowTemp` | 87 | ganz | TOP73 | `Z1_Cool_Curve_Target_Low_Temp` (°C, Rohwert − 128) — Kühlkurve: Vorlauf bei heißem Wetter, gehört zu Byte 89 |
| SET33 | `Z1CoolCurveOutsideLowTemp` | 88 | ganz | TOP75 | `Z1_Cool_Curve_Outside_Low_Temp` (°C, Rohwert − 128) — Kühlkurve: kühler Außentemperaturpunkt, 15…30 |
| SET34 | `Z1CoolCurveOutsideHighTemp` | 89 | ganz | TOP74 | `Z1_Cool_Curve_Outside_High_Temp` (°C, Rohwert − 128) — Kühlkurve: heißer Außentemperaturpunkt, 15…30 |
...
| SET17 | `CoolDelta` | 94 | ganz | TOP24 | `Cool_Delta` (K, Rohwert − 128) — Spreizung Kühlen |
|  |  | 95 | ganz | TOP79 | `Heat_To_Cool_Temp` (°C, Rohwert − 128) — Auto-Betrieb: Außentemperatur für den Wechsel Heizen → Kühlen; ob beschreibbar, ist nicht geprüft (3a) |
|  |  | 96 | ganz | TOP80 | `Cool_To_Heat_Temp` (°C, Rohwert − 128) — Auto-Betrieb: Außentemperatur für den Wechsel Kühlen → Heizen; ob beschreibbar, ist nicht geprüft (3a) |
| SET26 | `DHWRoomMaxTime` | 97 | ganz | TOP98 | `DHW_Room_Max_Time` (min, (Rohwert − 1) × 30) — Warmwasser: höchste Raumheizzeit. SET26 schreibt 30-min-Schritte, TOP98 meldet Minuten ⁴ |
| SET19 | `DHWHeatupTime` | 98 | ganz | TOP97 | `DHW_Heatup_Time` (min, Rohwert − 1) — Warmwasser: höchste Aufheizzeit |
| SET18 | `DHWHeatDelta` | 99 | ganz | TOP22 | `DHW_Heat_Delta` (K, Rohwert − 128) — Warmwasser: Nachheiz-Hysterese |
|  |  | 100 | ganz | TOP70 | `Sterilization_Temp` (°C, Rohwert − 128) — Desinfektion: Temperatur; ob beschreibbar, ist nicht geprüft (3a) |
|  |  | 101 | ganz | TOP71 | `Sterilization_Max_Time` (min, Rohwert − 1) — Desinfektion: höchste Dauer; ob beschreibbar, ist nicht geprüft (3a) |
...
|  |  | 118 | 1+2 |  | unbelegt |
|  |  | 118 | 3–5 | TOP6 | Nachkommastelle zu TOP6 `Main_Outlet_Temp`: 1–4 → .00/.25/.50/.75, sonst keine |
|  |  | 118 | 6–8 | TOP5 | Nachkommastelle zu TOP5 `Main_Inlet_Temp`, Kodierung wie Bits 3–5 |
...
|  |  | 139 | ganz | TOP56 | `Z1_Temp` (°C, Rohwert − 128) — Ist-Temperatur Zone 1 |
|  |  | 140 | ganz |  | Referenz: Ist-Temperatur Zone 2 (Rohwert − 128). Original: `Z2_Temp`. Zone 2 entfernt |
|  |  | 141 | ganz | TOP10 | `DHW_Temp` (°C, Rohwert − 128) — Warmwasser-Ist; Stufe 1 hat keinen Speicher und meldet −128 |
|  |  | 142 | ganz | TOP14 | `Outside_Temp` (°C, Rohwert − 128) — Außentemperatur |
|  |  | 143 | ganz | TOP5 | `Main_Inlet_Temp` (°C, Rohwert − 128) — Rücklauf (Wassereintritt); Nachkommastelle aus Byte 118 |
|  |  | 144 | ganz | TOP6 | `Main_Outlet_Temp` (°C, Rohwert − 128) — Vorlauf (Wasseraustritt); Nachkommastelle aus Byte 118 |
|  |  | 145 | ganz | TOP36 | `Z1_Water_Temp` (°C, Rohwert − 128) — Wassertemperatur Zone 1 |
|  |  | 146 | ganz |  | Referenz: Wassertemperatur Zone 2 (Rohwert − 128). Original: `Z2_Water_Temp` |
|  |  | 147 | ganz | TOP42 | `Z1_Water_Target_Temp` (°C, Rohwert − 128) — Wasser-Solltemperatur Zone 1 |
|  |  | 148 | ganz |  | Referenz: Wasser-Solltemperatur Zone 2 (Rohwert − 128). Original: `Z2_Water_Target_Temp` |
|  |  | 149 | ganz | TOP46 | `Buffer_Temp` (°C, Rohwert − 128) — Pufferspeicher; an dieser Anlage nicht vorhanden |
|  |  | 150 | ganz | TOP47 | `Solar_Temp` (°C, Rohwert − 128) — Solar; an dieser Anlage nicht vorhanden |
|  |  | 151 | ganz | TOP48 | `Pool_Temp` (°C, Rohwert − 128) — Pool; an dieser Anlage nicht vorhanden |
...
|  |  | 153 | ganz | TOP7 | `Main_Target_Temp` (°C, Rohwert − 128) — Vorlauf-Solltemperatur |
|  |  | 154 | ganz | TOP49 | `Main_Hex_Outlet_Temp` (°C, Rohwert − 128) — Austritt 2 hinter dem Wärmetauscher |
|  |  | 155 | ganz | TOP50 | `Discharge_Temp` (°C, Rohwert − 128) — Heißgas (Verdichteraustritt) |
|  |  | 156 | ganz | TOP33 | `Room_Thermostat_Temp` (°C, Rohwert − 128) — Raumthermostat RC-1, interner Fühler |
|  |  | 157 | ganz | TOP51 | `Inside_Pipe_Temp` (°C, Rohwert − 128) — Kältemittelleitung innen |
|  |  | 158 | ganz | TOP21 | `Outside_Pipe_Temp` (°C, Rohwert − 128) — Kältemittelleitung außen |
|  |  | 159 | ganz | TOP52 | `Defrost_Temp` (°C, Rohwert − 128) — Abtaufühler |
|  |  | 160 | ganz | TOP53 | `Eva_Outlet_Temp` (°C, Rohwert − 128) — Verdampferaustritt |
|  |  | 161 | ganz | TOP54 | `Bypass_Outlet_Temp` (°C, Rohwert − 128) — Bypass-Austritt |
|  |  | 162 | ganz | TOP55 | `Ipm_Temp` (°C, Rohwert − 128) — Leistungsmodul (IPM) |
|  |  | 163 | ganz | TOP64 | `High_Pressure` (kgf/cm², (Rohwert − 1) / 5) — Hochdruck |
|  |  | 164 | ganz | TOP66 | `Low_Pressure` (kgf/cm², Rohwert − 1) — Niederdruck. Skalierung ungeklärt: Referenz (Rohwert − 1) / 5, Original seit Dezember 2023 (Rohwert − 1) × 50; nicht nachgemessen |
|  |  | 165 | ganz | TOP67 | `Compressor_Current` (A, (Rohwert − 1) / 5) — Stromaufnahme Außeneinheit |
|  |  | 166 | ganz | TOP8 | `Compressor_Freq` (Hz, Rohwert − 1) — Verdichterfrequenz |
|  |  | 167 | ganz |  | Referenz: stets `0x00` |
|  |  | 168 | ganz |  | Referenz: stets `0x00` |
|  |  | 169 | ganz | TOP1 | `Pump_Flow` (l/min) — Durchfluss, Nachkommaanteil: (Rohwert − 1) / 256 |
|  |  | 170 | ganz | TOP1 | `Pump_Flow` (l/min) — Durchfluss, ganze l/min; TOP1 = Byte 170 + (Byte 169 − 1) / 256 |
|  |  | 171 | ganz | TOP65 | `Pump_Speed` (1/min, (Rohwert − 1) × 50) — Pumpendrehzahl (Ist) |
|  |  | 172 | ganz | TOP92 | `Pump_Duty` (Duty, Rohwert − 1) — Pumpenmodulation (Ist); folgt im Handbetrieb genau der Grenze aus Byte 45 ⁵ |
|  |  | 173 | ganz | TOP62 | `Fan1_Motor_Speed` (1/min, (Rohwert − 1) × 10) — Lüfter 1 |
|  |  | 174 | ganz | TOP63 | `Fan2_Motor_Speed` (1/min, (Rohwert − 1) × 10) — Lüfter 2 |
...
|  |  | 179 | ganz | TOP12 | `Operations_Counter` (Anzahl) — Verdichterstarts, niederwertiges Byte; TOP12 = Byte 180 × 256 + Byte 179 − 1 |
|  |  | 180 | ganz | TOP12 | `Operations_Counter` (Anzahl) — Verdichterstarts, höherwertiges Byte |
|  |  | 181 | ganz |  | Referenz: stets `0x00` |
|  |  | 182 | ganz | TOP11 | `Operations_Hours` (h) — Betriebsstunden, niederwertiges Byte; TOP11 = Byte 183 × 256 + Byte 182 − 1 |
|  |  | 183 | ganz | TOP11 | `Operations_Hours` (h) — Betriebsstunden, höherwertiges Byte |
|  |  | 184 | ganz |  | Referenz: stets `0x00` |
|  |  | 185 | ganz | TOP90 | `Room_Heater_Operations_Hours` (h) — Betriebsstunden Raumheizstab, niederwertiges Byte; Bildung wie TOP11 |
|  |  | 186 | ganz | TOP90 | `Room_Heater_Operations_Hours` (h) — Betriebsstunden Raumheizstab, höherwertiges Byte |
|  |  | 187 | ganz |  | Referenz: stets `0x00` |
|  |  | 188 | ganz | TOP91 | `DHW_Heater_Operations_Hours` (h) — Betriebsstunden Warmwasser-Heizstab, niederwertiges Byte; Bildung wie TOP11 |
|  |  | 189 | ganz | TOP91 | `DHW_Heater_Operations_Hours` (h) — Betriebsstunden Warmwasser-Heizstab, höherwertiges Byte |
...
|  |  | 193 | ganz | TOP16 | `Heat_Energy_Consumption` (W, (Rohwert − 1) × 200) — Leistungsaufnahme Heizen, 200-W-Raster |
|  |  | 194 | ganz | TOP15 | `Heat_Energy_Production` (W, (Rohwert − 1) × 200) — Wärmeleistung Heizen, 200-W-Raster |
|  |  | 195 | ganz | TOP39 | `Cool_Energy_Consumption` (W, (Rohwert − 1) × 200) — Leistungsaufnahme Kühlen, 200-W-Raster |
|  |  | 196 | ganz | TOP38 | `Cool_Energy_Production` (W, (Rohwert − 1) × 200) — Kälteleistung Kühlen, 200-W-Raster |
|  |  | 197 | ganz | TOP41 | `DHW_Energy_Consumption` (W, (Rohwert − 1) × 200) — Leistungsaufnahme Warmwasser, 200-W-Raster |
|  |  | 198 | ganz | TOP40 | `DHW_Energy_Production` (W, (Rohwert − 1) × 200) — Wärmeleistung Warmwasser, 200-W-Raster |
...
SET- und TOP-Spalte sind aus den beiden Code-Tabellen erzeugt, über dieselben
Parser wie in [`test/set_top_zuordnung.py`](test/set_top_zuordnung.py), und
dabei maschinell geprüft: Jedes Set-Kommando und jedes State-Topic liegt auf
